...
import { ArrowRight, Mail, Phone, MapPin, Download, Github, Linkedin, MessageSquare } from 'lucide-react';
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              <motion.a
                href="https://raw.githubusercontent.com/TayyubKhan/portfolio-assets/main/Tayyub-the-flutter-developer.pdf"
                download
                target="_blank"
          ...
          <motion.div variants={itemVariants}>
            <div className="flex flex-col lg:flex-row gap-6 justify-center items-center text-slate-600 dark:text-slate-400 mb-8">
              ...
              >
                ...
                <span className="font-medium">tayyubshafiquek@gmail.com</span>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="flex items-center bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700"
              >
                ...
                <span className="font-medium">+92 321 4965066</span>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="flex items-center bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700"
